...
extern void     Cal_ShowRectStringWithColor(CHAR *pStr, PURECT pRect, BOOL bClear,UINT32 color);
extern void     Cal_ShowStringByColor(CHAR *pStr, PURECT pRect, UINT32 uiFrColor, UINT32 uiBgColor);
extern void     Cal_FillRect(PURECT pRect, UINT32 uiBgColor);
extern void     Cal_ShowString(INT8 *pStr, PURECT pRect, BOOL bClear);
