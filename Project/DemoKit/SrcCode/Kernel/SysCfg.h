...
#if 0//(_INTERSTORAGE_ == _INTERSTORAGE_SPI_)
...
#else
#define POOL_SIZE_PS_BUFFER     (ALIGN_CEIL_32(0x20000)+ALIGN_CEIL_32(0x20000))//(0x1800)) // 134K bytes = 1 block size + about 6K work
#endif
...
#define POOL_SIZE_GFX_TEMP      ALIGN_CEIL_32((VDO_W*VDO_H*2)+(0x1000))//(POOL_SIZE_DISP_VDO2+(0x1000)) //at least 4k for Gxlib
...
#define POOL_SIZE_HTTPLVIEW     ALIGN_CEIL_32(0xD00000)
#else
