...
extern int wifi_set_wlan0_efuse_mac(char *pMacAddr); //0 success, -1 fail


/*exported API , for write value to efuse ; 20150225 add
return value: 0 success,  -1 fail */
extern int wifi_set_cck_pwr_to_efuse(char *StrInput);
extern int wifi_set_HT40_1s_A_to_efuse(char *StrInput);
extern int wifi_set_pwrDiff_ht20ofdm_to_efuse(char *StrInput);
extern int wifi_set_ther_to_efuse(char *StrInput);
extern int wifi_set_xcap_to_efuse(char *StrInput);
