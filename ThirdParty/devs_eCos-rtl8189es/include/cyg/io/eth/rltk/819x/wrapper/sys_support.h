...
#if defined(CONFIG_SDIO_NOVA) && !defined(CONFIG_RTL_KERNEL_TIMER)
#define	HZ 			100
#else
...
#if 1
#define cpu_to_be16(_x_)		CYG_CPU_TO_BE16(_x_)
#define cpu_to_be32(_x_)		CYG_CPU_TO_BE32(_x_)
#define be16_to_cpu(_x_)		CYG_BE16_TO_CPU(_x_)
#define be32_to_cpu(_x_)		CYG_BE32_TO_CPU(_x_)

#define cpu_to_le16(_x_)		CYG_CPU_TO_LE16(_x_)
#define cpu_to_le32(_x_)		CYG_CPU_TO_LE32(_x_)
#define le16_to_cpu(_x_)		CYG_LE16_TO_CPU(_x_)
#define le32_to_cpu(_x_)		CYG_LE32_TO_CPU(_x_)

#define le32_to_cpup(_x_)	CYG_LE32_TO_CPU((cyg_uint32)(_x_))
#else
...
#define spin_lock_bh(x)				do {cyg_drv_dsr_lock();} while (0)
#define spin_unlock_bh(x)			do {cyg_drv_dsr_unlock();} while (0)
