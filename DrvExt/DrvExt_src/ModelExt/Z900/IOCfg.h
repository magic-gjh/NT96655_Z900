...
#define GPIO_ACC_DET           P_GPIO_47           // Key Shutter2 (ks2)
#define PAD_ACC_DET            PAD_PIN_PGPIO47

extern BOOL  GPIOMap_ACC_Det(void);

#define GPIO_SYSTEM_STATUS 	P_GPIO_40//P_GPIO_10
#define PAD_SYSTEM_STATUS             PAD_PIN_PGPIO40
