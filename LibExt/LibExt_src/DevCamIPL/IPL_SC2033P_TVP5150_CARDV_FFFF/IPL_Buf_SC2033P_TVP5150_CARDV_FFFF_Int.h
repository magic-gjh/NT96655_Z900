#ifndef IPL_BUF_OV9712_TVP5150_CARDV_FFFF_H_
#define IPL_BUF_OV9712_TVP5150_CARDV_FFFF_H_
...
typedef enum {
    ...
    IPLBUF_MODE_FLOW_D,         ///< for FW Trig mode
...
#endif //IPL_BUF_OV9712_TVP5150_CARDV_FFFF_H_
