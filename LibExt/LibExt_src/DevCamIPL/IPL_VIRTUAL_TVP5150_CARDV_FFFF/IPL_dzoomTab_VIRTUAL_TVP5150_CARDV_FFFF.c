/**
    IPL dzoom table VIRTUAL_TVP5150_CARDV_FFFF.

    @file       IPL_dzoomTableVIRTUAL_TVP5150_CARDV_FFFF.c
    @ingroup    mISYSAlg
...
#include "IPL_VIRTUAL_TVP5150_CARDV_FFFF_Int.h"
...
const UINT32 VDOZOOM_VIRTUAL_INFOR_MODE_1_TABLE[31][DZOOM_ITEM_MAX] =
{
    //sie         sie
    //crop out    ch0 out      pre in
...
const UINT32 VDOZOOM_VIRTUAL_INFOR_MODE_2_TABLE[31][DZOOM_ITEM_MAX] =
{
    //sie        sie
    //crop out   ch0 out     pre in
    //{ 640, 360, 640, 360, 640, 360},
...
UINT32* SenMode2Tbl(IPL_PROC_ID Id, UINT32 SenMode, UINT32 *DzMaxidx)
{
    ...
    if (Id == IPL_ID_1)
    {
        ...
        {
            case SENSOR_MODE_1:
                Ptr = (UINT32*)&VDOZOOM_VIRTUAL_INFOR_MODE_1_TABLE[0][0];
                *DzMaxidx = (sizeof(VDOZOOM_VIRTUAL_INFOR_MODE_1_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;

            case SENSOR_MODE_2:
                Ptr = (UINT32*)&VDOZOOM_VIRTUAL_INFOR_MODE_2_TABLE[0][0];
                *DzMaxidx = (sizeof(VDOZOOM_VIRTUAL_INFOR_MODE_2_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;
