#ifndef _IQS_SETTINGFLOW_VIRTUAL_TVP5150_CARDV_FFFF_C
#define _IQS_SETTINGFLOW_VIRTUAL_TVP5150_CARDV_FFFF_C
...
static char     IQS_VIRTUAL_VerInfo[]    = "IQS20130306B";
static char     IQS_VIRTUAL_BuildDate[]  = __DATE__ ", " __TIME__;
...
ER IQCB_SettingFlowFunc(IQS_FLOW_MSG MsgID, ENG_SUBFUNC *Info, IPL_HAL_GROUP* group)
{
    switch((UINT32)MsgID)
    {
        ...
        case IQCB_PRV_SIE_INIT:
            IQS_SetVerInfo(IQS_VIRTUAL_VerInfo);
            IQS_SetBuildDate(IQS_VIRTUAL_BuildDate);
            break;
