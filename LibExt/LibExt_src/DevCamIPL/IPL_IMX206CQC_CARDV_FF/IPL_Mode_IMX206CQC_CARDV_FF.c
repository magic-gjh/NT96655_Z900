        ...
        case IPL_MODE_VIDEOREC:
            switch(Video_FPS)
            {
                ...
                case SEL_VIDEOFPS_60:
                    ...
                    IPL_AlgSetUIInfo(IPL_SEL_CAPSENMODE, SENSOR_MODE_7);
...
static ER IPL_Rec2Cap(IPL_CHGMODE_DATA *ChgMode, IPL_CHGMODE_DATA *PrvMode)
{
    ...
    IPL_FCB_AlgRSC(0,SEL_RSC_PAUSE);
...
static ER IPL_Vid2Rec(IPL_CHGMODE_DATA *ChgMode, IPL_CHGMODE_DATA *PrvMode)
{
    ...
    IPL_CtrlSetInfor(IPL_ID_1, IPLCTRL_RSC_EN, ENABLE);
    IPL_CtrlSetInfor(IPL_ID_1, IPLCTRL_RSC_RATIO, 10);
