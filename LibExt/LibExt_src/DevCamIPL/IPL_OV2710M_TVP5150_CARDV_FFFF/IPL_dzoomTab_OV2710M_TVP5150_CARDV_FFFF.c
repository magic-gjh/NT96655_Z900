/**
    IPL dzoom table OV2710M_TVP5150_CARDV_FFFF.

    @file       IPL_dzoomTableOV2710M_TVP5150_CARDV_FFFF.c
    @ingroup    mISYSAlg
...
const UINT32 VDOZOOM_OV2710M_INFOR_MODE_1_TABLE[31][DZOOM_ITEM_MAX] =
{
    //sie         sie
    //crop out    ch0 out      pre in
...
const UINT32 VDOZOOM_OV2710M_INFOR_MODE_2_TABLE[31][DZOOM_ITEM_MAX] =
{
    //sie         sie
    //crop out    ch0 out      pre in
{ 1920, 1080, 1920, 1080, 1920, 1080},
...
const UINT32 VDOZOOM_OV2710M_INFOR_MODE_3_TABLE[31][DZOOM_ITEM_MAX] =
{
     //sie        sie
    //crop out   ch0 out     pre in
...
const UINT32 VDOZOOM_OV2710M_INFOR_MODE_4_TABLE[31][DZOOM_ITEM_MAX] =
{
    //sie        sie
    //crop out   ch0 out     pre in
...
UINT32* SenMode2Tbl(IPL_PROC_ID Id, UINT32 SenMode, UINT32 *DzMaxidx)
{
    ...
    if (Id == IPL_ID_1)
    {
        ...
        {
            case SENSOR_MODE_1:
                Ptr = (UINT32*)&VDOZOOM_OV2710M_INFOR_MODE_1_TABLE[0][0];
                *DzMaxidx = (sizeof(VDOZOOM_OV2710M_INFOR_MODE_1_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;

            case SENSOR_MODE_2:
                Ptr = (UINT32*)&VDOZOOM_OV2710M_INFOR_MODE_2_TABLE[0][0];
                *DzMaxidx = (sizeof(VDOZOOM_OV2710M_INFOR_MODE_2_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;

            case SENSOR_MODE_3:
                Ptr = (UINT32*)&VDOZOOM_OV2710M_INFOR_MODE_3_TABLE[0][0];
                *DzMaxidx = (sizeof(VDOZOOM_OV2710M_INFOR_MODE_3_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;
            case SENSOR_MODE_4:
                Ptr = (UINT32*)&VDOZOOM_OV2710M_INFOR_MODE_4_TABLE[0][0];
                *DzMaxidx = (sizeof(VDOZOOM_OV2710M_INFOR_MODE_4_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;
