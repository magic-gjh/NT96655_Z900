...
static ER IPL_Vid2Rec(IPL_CHGMODE_DATA *ChgMode, IPL_CHGMODE_DATA *PrvMode)
{
    ...
    Video_FPS = IPL_AlgGetUIInfo(IPL_SEL_VIDEO_FPS);
    switch(Video_FPS)
    {
        case SEL_VIDEOFPS_30:
            IPL_AlgSetUIInfo(IPL_SEL_PRVSENMODE, SENSOR_MODE_3);
            SetCalSensorMode(SENSOR_MODE_3);
            break;
        case SEL_VIDEOFPS_60:
            IPL_AlgSetUIInfo(IPL_SEL_PRVSENMODE, SENSOR_MODE_4);
            SetCalSensorMode(SENSOR_MODE_4);
            break;
        case SEL_VIDEOFPS_120:
            IPL_AlgSetUIInfo(IPL_SEL_PRVSENMODE, SENSOR_MODE_5);
            SetCalSensorMode(SENSOR_MODE_5);
            break;
        case SEL_VIDEOFPS_240:
            IPL_AlgSetUIInfo(IPL_SEL_PRVSENMODE, SENSOR_MODE_6);
            SetCalSensorMode(SENSOR_MODE_6);
            break;
        case SEL_VIDEOFPS_25:
        case SEL_VIDEOFPS_FULLRES:
        default:
            IPL_AlgSetUIInfo(IPL_SEL_PRVSENMODE, SENSOR_MODE_7);
            SetCalSensorMode(SENSOR_MODE_7);
            break;
    }
    //change sensor mode
...
static ER IPL_Off2Prv(IPL_CHGMODE_DATA *ChgMode, IPL_CHGMODE_DATA *PrvMode)
{
    ...
    {
        //dual sensor flow
        IPL_CtrlSetInfor(IPL_ID_1, IPLCTRL_PRVFLOW, ICF_FLOW_B);
...
static ER IPL_Prv2Cap(IPL_CHGMODE_DATA *ChgMode, IPL_CHGMODE_DATA *PrvMode)
{
    ...
    SetCalSensorMode(SENSOR_MODE_2);
