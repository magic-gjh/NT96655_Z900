...
*/
//@{
#define GainExpTShiftNum            1                           ///< Gain and ExpT Setting Timing VD shift number
...
#define AE_MOV_EXPECT_Y             292  //366//(27<<4)                ///< expectY 100 //for video recording  lydia
#define AE_PHOTO_EXPECT_Y          486  // 608                         ///< expectY 128 //for photo mode  lydia
#define AE_EXPECT_Y2                763//905//(911)             ///< histogram expectY2 150
#define AE_EXPECT_Y4                2604//(2572)                ///< (Luminance Y) 220

#define AE_MAX_ISO                  2400                        ///< max iso
